  ...
  <div class="well">
    ...
    <div>
      ...
      <div class="card card-body bg-light">
        ...
        <h6><a class="text-secondary" target="_blank" href="storage/uploaded_minutes/{{$minute->minute_dir}}">Minutes for {{$minute->meeting_date}} meeting </a> <span>  <a href="storage/uploaded_minutes/{{$minute->minute_dir}}" download><button class="btn btn-primary float-right">Download <i class="fas fa-download"></i></button></a> <button class="btn btn-sm btn-outline-danger float-right m-1" data-toggle="tooltip" title="Delete this minute"><i class=" fas fa-trash-alt"></i></button></span></h6>
